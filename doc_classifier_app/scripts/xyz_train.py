...
class Train():
	...
	def get_train_vectors(self, data, identifier):
		col1=data.columns[0]
		col2=data.columns[1]
	...
	def train_file_model(self, filePath):
		...
		train_vectors= self.get_train_vectors(data,filePath)
...
if __name__ == "__main__":
	...
	objTrain.train_file_model("give the file path here..")
